...
<main id="art">
    @if(count($newest))
        ...
        <header class="spotlight-header" style="background-image: url({{$newest->image_artwork}});">
            <div class="container">
                <article class="spotlight-header__info">
                    <h1 class="spotlight-header__info--title">{{$newest->title}}</h1>
                    ...
                    <a href="{{ route( 'show', $parameters = array( $newest->slug ), $attributes = array() ) }}" class="spotlight-header__info--btn">
